...
public class Config {
	...
	public static String UNION = "{?s dbo:country dbr:Vietnam.} \r\n"
    + "UNION {?s dbp:country dbr:Vietnam.} UNION {?s dct:subject dbc:Vietnamese_cuisine} UNION {?s rdf:type yago:WikicatVietnameseRiceDishes}";
	...
	public static void process(String queryStr, String name) throws FileNotFoundException {
        ...
        OutputStream out = new FileOutputStream("D:\\OOP_midterm\\23\\src\\main\\resources\\" + name + ".ttl");
